        ...
        <div class="news-content-wrapper d-flex justify-content-center rounded p-4">
            <div class="news-content d-flex flex-column w-75 p-3" style="height: fit-content;">
                <div class="container-fluid">
                    ...
                    <img class="rounded mx-auto d-block" src="{{ asset('assets/images/article/jasamarga-surabaya.jpg') }}" style="width: 650px; height: 500px">
            ...
            <div class="d-flex flex-column w-25 py-5">
                ...
                <div class="highlight-news-item d-flex flex-column my-2">
                    <a href="/beritatol/1">
                        ...
                        <div class="d-flex flex-row">
                            <img class="rounded img-fluid news-image-highlight mr-2 mt-2" src="{{ asset('assets/images/article/cikampek-km39.jpeg') }}">
                            <p>Jakarta (08/02) - Sehubungan dengan informasi yang
                                beredar
