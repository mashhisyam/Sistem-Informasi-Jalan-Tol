...
@include('components.titlebar', ["title" => "Contact Us", 'poster' => "assets/images/title-bar-bg-2.jpg"])
          ...
          <div class="col-md-6 col-lg-4 offset-lg-2 mb-4 mb-md-0">
            <div class="contact__content">
              ...
              <div class="mb-3">
                ...
                <div>
                  <i class="fas fa-map-marker-alt icon--left d-inline-block"
                    style="margin-top: 0.2rem; float:left;"></i>
              ...
              <div class="social-links">
                <a href=" " class="btn-icon"><i class="fab fa-facebook-f"><img
                      src="{{ asset('assets/images/facebook-removebg-preview.png') }}" alt="image" height="30"
                      width="30"></i></a>
                <a href=" " class="btn-icon"><i class="fab fa-twitter">><img
                      src="{{ asset('assets/images/twitter-removebg-preview.png') }}" alt="image" height="30"
                      width="30"></i></a>
                <a href=" " class="btn-icon"><i class="fab fa-instagram"><img
                      src="{{ asset('assets/images/instagram-removebg-preview.png') }}" alt="image" height="30"
                      width="30"></i></a>
                <a href=" " class="btn-icon"><i class="fab fa-youtube"><img
                      src="{{ asset('assets/images/youtube-removebg-preview.png') }}" alt="image" height="30"
                      width="30"></i></a>
              </div>
            </div>
          </div>
